...
const Footer = () => {
  return (
    <footer className="max-w-7xl mx-auto px-6 relative bg-base-200 pt-16 pb-8 overflow-hidden">
      {/* Background Decorative Element */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px bg-linear-to-r
      from-transparent via-teal-500 to-transparent opacity-30"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <div className="flex flex-col space-y-4 items-center md:items-start text-center md:text-left">
          <div className="flex items-center gap-3">
            <motion.img
              ...
              alt="Logo"
            />
            <h2 className="text-amber-500 ml-4 font-bold text-xl">
              CONTESTVERSE
            </h2>
          </div>
          <p className="text-base-content/60 text-sm max-w-xs leading-relaxed">
            The ultimate arena for creators. Showcase your talent, compete with
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-base-content font-bold uppercase tracking-widest text-sm mb-6">
            Quick Navigation
          </h3>
      ...
      <div className="mt-16 pt-8 border-t border-base-content/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-base-content/50">
          <p>
            ...
            <span className="text-teal-600 font-bold">ContestVerse</span>. All
            rights reserved.
          </p>
