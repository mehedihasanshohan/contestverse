...
const PerformanceMetrics = () => {
  return (
    <section className="max-w-7xl mx-auto px-6 py-12 bg-base-200 overflow-hidden pb-24">
      {/* Title */}
      <motion.div
      ...
      >
        <Title>Platform Live Pulse</Title>
        <Subtitle>
          Real-time breakdown of our ecosystem performance and category
          distribution.
        </Subtitle>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <h3 className="text-xl font-bold mb-6 px-4">
